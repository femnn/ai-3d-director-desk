...
function ObjectSceneNode({
  ...
  const faceClips = useDirectorStore((state) => state.project.characterFaceClips ?? []);
...
function ObjectAnimationRig({
  ...
  useFrame(() => {
    ...
    const sequenceControlsScene = Boolean(animationSequence && runtime.sequenceId === animationSequence.id);
