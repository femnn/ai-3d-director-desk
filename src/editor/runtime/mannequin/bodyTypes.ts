...
export const CHARACTER_BODY_PRESETS: CharacterBodyPreset[] = [
  ...
  preset("face-capture", "面捕演员", 2.2, {
    hipY: 0.72,
    pelvisRadius: 0.2,
    pelvisScale: [1.08, 0.5, 0.72],
    legSpread: 0.15,
    torsoLowerRadius: 0.15,
    torsoUpperRadius: 0.19,
    torsoLowerHeight: 0.25,
    torsoUpperHeight: 0.44,
    torsoLowerScale: [0.88, 0.98, 0.74],
    torsoUpperScale: [1.08, 1.03, 0.78],
    shoulderWidth: 0.31,
